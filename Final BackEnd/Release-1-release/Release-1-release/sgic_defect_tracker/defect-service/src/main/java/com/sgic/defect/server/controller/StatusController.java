...
public class StatusController {
	...
	public ResponseEntity<Object> getAllStatus() {
		...
		return new ResponseEntity<>(new ListContentResponse<StatusDto>("gfsyvvjkju",statusData, RestApiResponseStatus.RECEIVED), HttpStatus.OK);	
	}
	...
	public ResponseEntity<Object> removeStatus(@RequestBody StatusDto statusData) {
		Long id = statusData.getId();
		if(statusService.isIdExists(id)) {
	...
	public ResponseEntity<Object> getStatusById(@PathVariable Long id) {
		...
		return new ResponseEntity<>(new ContentResponse<StatusDto>("xyhhdgdfkkjx", statusData, RestApiResponseStatus.RECEIVED), HttpStatus.OK);	
	}
